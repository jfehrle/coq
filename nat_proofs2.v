(* Print HintDb core. *)
Hint Extern 2 => foreach IND: induction IND : plus.
...
Hint Extern 1 => rewrite <- my_plus_n_Sm : plus.

Theorem my_plus_comm : forall m n: nat,
  n + m = m + n.
Time info_auto 9 with nocore plus.
Qed.
Hint Extern 2 => rewrite <- my_plus_comm : plus.
...
Time info_auto 9 with nocore plus.
Qed.
Hint Extern 2 => rewrite <- my_plus_assoc : plus.
...
*)
Qed.
Hint Extern 1 => rewrite <- my_mult_n_Sm : plus.
...
- progress simpl.
  ...
  reflexivity. *)
Qed.
Hint Extern 1 => rewrite -> my_dist_plus_mul : plus.
